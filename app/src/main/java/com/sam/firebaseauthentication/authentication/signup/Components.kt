...
package com.sam.firebaseauthentication.authentication.signup // Or your chosen components package
...
import com.sam.firebaseauthentication.authentication.signin.CustomTextField // Make sure this import is correct
import com.sam.firebaseauthentication.components.VerticalSpacer // Make sure this import is correct
...
fun CompanyInfo(modifier: Modifier = Modifier) {
    Box (
        ...
        Text(
            text = "Swift-Dhan", // Or your company name
